...
class Polygon2:
    ...
    def drawRectangularGrid(self,wx,wy):
        ...
        # pygame.draw.line(self.dis,(255,0,0),cooordRect[0],(xMax,cooordRect[3][1]))
        # pygame.draw.line(self.dis, (255, 0, 0), cooordRect[0], (xMax,cooordRect[1][1]))
        #
        # pygame.draw.line(self.dis, (255, 0, 0), cooordRect[1], (cooordRect[2][0], yMax))
        # pygame.draw.line(self.dis, (255, 0, 0), cooordRect[1], (cooordRect[0][0], yMax))
        #
        # pygame.draw.line(self.dis, (255, 0, 0), cooordRect[2], (xMin, cooordRect[3][1]))
        # pygame.draw.line(self.dis, (255, 0, 0), cooordRect[2], (xMin, cooordRect[1][1]))
        #
        # pygame.draw.line(self.dis, (255, 0, 0), cooordRect[3], (cooordRect[2][0], yMin))
        # pygame.draw.line(self.dis, (255, 0, 0), cooordRect[3], (cooordRect[0][0], yMin))
        ...
        while coordR[1] < yMax:
            ...
            if self.poly.intersects(gridOne) == 1:
                ...
                pygame.draw.rect(self.dis, (255, 0, 0), (coordInArea[i].x, coordInArea[i].y, wx, wy), 2)
                i += 1
            else:
                maskaCoord.append(1)
            ...
            # if self.pointInPolygon(coordR[0],coordR[1]) == 1:
            #     coordInArea.append(Point(coordR[0] - wx/2,coordR[1]-wy/2))
            #     coordInAreaCenter.append(Point(coordR[0],coordR[1]))
            #     pygame.draw.rect(self.dis, (0, 255, 0), (coordInArea[i].x, coordInArea[i].y, wx, wy), 1)
            #     i +=1
            # else:
            #     pygame.draw.rect(self.dis, (255, 0, 0), (coordR[0] - wx / 2, coordR[1] - wy / 2, wx, wy), 1)
            # coordR[0] += wx
